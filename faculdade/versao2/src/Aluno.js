...
export default class Aluno {
  ...
  // Declarando os atributos de Aluno como privados. 
  //
  #matricula;
  #cpf;
  #nome;
  ...
  // 
  // Como os atributos de Aluno são privados, o método estático JSON.stringify não vai funcionar.
  // Assim, colocamos o método toJSON para devolver a representação do objeto Aluno na forma
  // de uma string JSON
  //
  toJSON() {
    return '{' +
